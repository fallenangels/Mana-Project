...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit news" onclick="javascript:CKEDITOR.instances.news_content.destroy();CKEDITOR.instances.news_summary.destroy();" /> or <?php echo anchor(SITE_AREA .'/settings/news', lang('news_cancel')); ?>
	</div>
	<?php echo form_close(); ?>
