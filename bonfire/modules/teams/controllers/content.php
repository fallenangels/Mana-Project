...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Teams.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Teams.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_teams())
			{
				...
				Template::redirect(SITE_AREA .'/content/teams');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Teams.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/teams');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Teams.Content.Delete');
