...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Teams.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Teams.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_teams())
			{
				...
				Template::redirect(SITE_AREA .'/reports/teams');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Teams.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/teams');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Teams.Reports.Delete');
