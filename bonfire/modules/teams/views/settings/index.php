...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('teams_no_records'); ?> <?php echo anchor(SITE_AREA .'/settings/teams/create', lang('teams_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/settings/teams/create')?>"><?php echo lang('teams_create_new_button');?></a>
...
?>
				<td><?php echo anchor(SITE_AREA .'/settings/teams/edit/'. $record['id'], lang('teams_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
