<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA . reports .'/'. teams .'/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/reports/teams/edit/'. $record[$primary_key_field], lang('teams_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
