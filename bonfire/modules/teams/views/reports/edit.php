...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit teams" /> or <?php echo anchor(SITE_AREA .'/reports/teams', lang('teams_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/teams/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('teams_delete_confirm'); ?>')"><?php echo lang('teams_delete_record'); ?></a>
