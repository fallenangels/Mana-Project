...
class content extends Admin_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('test_types/test_types_model', 'test_types_model', true);
        $this->lang->load('test');
    }
    ...
    public function create() {
        ...
        $typeOptions = $this->test_types_model->find_all();
        $options = array();
        foreach ($typeOptions as $option) {
            $options[$option->id] = $option->test_types_name;
        }
        Template::set('typeOptions', $options);
