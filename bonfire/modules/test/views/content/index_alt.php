<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA . content .'/'. test .'/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/content/test/edit/'. $record[$primary_key_field], lang('test_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
