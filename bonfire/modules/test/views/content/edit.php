...
<?php $options = $typeOptions; ?>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit test" /> or <?php echo anchor(SITE_AREA .'/content/test', lang('test_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/test/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('test_delete_confirm'); ?>')"><?php echo lang('test_delete_record'); ?></a>
