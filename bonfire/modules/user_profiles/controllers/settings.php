...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('User_profiles.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('User_profiles.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_user_profiles())
			{
				...
				Template::redirect(SITE_AREA .'/settings/user_profiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('User_profiles.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/user_profiles');
		}
