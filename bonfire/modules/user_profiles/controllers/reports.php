...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('User_profiles.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('User_profiles.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_user_profiles())
			{
				...
				Template::redirect(SITE_AREA .'/reports/user_profiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('User_profiles.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/user_profiles');
		}
