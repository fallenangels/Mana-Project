...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit user_profiles" /> or <?php echo anchor(SITE_AREA .'/content/user_profiles', lang('user_profiles_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/user_profiles/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('user_profiles_delete_confirm'); ?>')"><?php echo lang('user_profiles_delete_record'); ?></a>
