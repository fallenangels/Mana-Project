<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA . content .'/'. user_profiles .'/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/content/user_profiles/edit/'. $record[$primary_key_field], lang('user_profiles_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
