...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Team_rosters.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Team_rosters.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_team_rosters())
			{
				...
				Template::redirect(SITE_AREA .'/content/team_rosters');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Team_rosters.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/team_rosters');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Team_rosters.Content.Delete');
