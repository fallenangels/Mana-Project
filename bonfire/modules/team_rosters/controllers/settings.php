...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Team_rosters.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Team_rosters.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_team_rosters())
			{
				...
				Template::redirect(SITE_AREA .'/settings/team_rosters');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Team_rosters.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/team_rosters');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Team_rosters.Settings.Delete');
