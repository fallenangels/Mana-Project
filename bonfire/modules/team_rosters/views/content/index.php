...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('team_rosters_no_records'); ?> <?php echo anchor(SITE_AREA .'/content/team_rosters/create', lang('team_rosters_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/content/team_rosters/create')?>"><?php echo lang('team_rosters_create_new_button');?></a>
...
?>
				<td><?php echo anchor(SITE_AREA .'/content/team_rosters/edit/'. $record['id'], lang('team_rosters_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
