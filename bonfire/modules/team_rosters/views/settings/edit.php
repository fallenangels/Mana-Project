...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit team_rosters" /> or <?php echo anchor(SITE_AREA .'/settings/team_rosters', lang('team_rosters_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/team_rosters/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('team_rosters_delete_confirm'); ?>')"><?php echo lang('team_rosters_delete_record'); ?></a>
		
		<h3><?php echo lang('team_rosters_delete_record'); ?></h3>
