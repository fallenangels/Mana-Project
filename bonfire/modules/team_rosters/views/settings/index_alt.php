<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA . settings .'/'. team_rosters .'/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/settings/team_rosters/edit/'. $record[$primary_key_field], lang('team_rosters_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
